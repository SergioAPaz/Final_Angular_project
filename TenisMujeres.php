...
<head>
    ...
    <link href="./assets/css/TenisMujeres.css" rel="stylesheet">
...
<body ng-controller="mainctrl">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 hidden-xs hidden-sm hidden-md">
                <div class="centrar2" style="height:642px;background-color:#222;margin:20px;border-radius: 5px;">
                    <span style="font-family: 'Montserrat', sans-serif;  color:#EC407A;">Moda y accesorios para ELLAS</span>
                </div>
            </div>
            ...
            <div class="col-xs-12 hidden-xs  hidden-lg">
                <div class="centrar3" style="height:100px;background-color:#222;margin:20px;">
                    <b style="font-family: 'Montserrat', sans-serif;  ">
                        <p>Moda y accesorios para <span style="color:#EC407A;">ELLAS</span></p>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-8" style="margin-top:20px;">
                <img src="./images/catalogo/dos.jpg" class="img-responsive" style="border-radius:5px" alt="">
            </div>
    ...
    <div class="container" style="margin-top:12px">
        <div class="alert alert-info" role="alert" style="background-color:#F06292;color:#424242"> <b>Conoce la gran variedad que tenemos para lo que buscas.</b></div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <!--<div class="col-xs-12 col-md-3">
                <div class="thumbnail">
                    <img src="images/catalogo/00.jpg" alt="...">
                    <div class="caption">
                        <h4>NIKE FLYKNIT RACER</h4>
                        <p>CALZADO DE RUNNING UNISEX</p>
                        <p>$1259.00</p>
                        <p>
                            <a href="#" class="btn btn-primary btn-sm" role="button">Comprar</a>
                            <a href="#" class="btn btn-default btn-sm" role="button">Ir a seccion</a>
                        </p>
                    </div>
                </div>
            </div>-->
